...
public class NeedBloodFragment extends Fragment {
	...
	class LoadAlldonors extends AsyncTask<String, String, String> {
	    ...
	    protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("reqLatitude",(String) hms.get("latitude") ));
            params.add(new BasicNameValuePair("reqLongitude",(String) hms.get("longitude") ));
            params.add(new BasicNameValuePair("userid", (String) hms.get("id")));
	...
	protected void showCustomDialog(View v,final List<NeedBloodItem> needlist,final int position,Context cnxt) {
	    ...
	    CustomDialog.Builder builder = new CustomDialog.Builder(getActivity(),"Details", "Make Appointment");
