...
public class AppointmentForm extends Fragment{
	...
	class addAppointment extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            Integer group = AppConfig.type;
            params.add(new BasicNameValuePair("meet", "m"));
            params.add(new BasicNameValuePair("donorUID", uid.toString()));
            params.add(new BasicNameValuePair("reqUID", hms.get("id")));
            params.add(new BasicNameValuePair("donPhone", MainActivity1.donContact));
            params.add(new BasicNameValuePair("reqPhone", hms.get("phone")));
            params.add(new BasicNameValuePair("reqNAME", AppConfig.patientName));
            params.add(new BasicNameValuePair("donNAME", MainActivity1.donName));
            params.add(new BasicNameValuePair("reqUNAME", hms.get("name")));
            params.add(new BasicNameValuePair("bloodgroup",group.toString()));
